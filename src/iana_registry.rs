...
pub const LANGUAGES: [LanguageSubtag; 8139] = [
...
pub const LANGUAGES_PREFERRED_VALUE: [(LanguageSubtag, LanguageSubtag); 78] = [
    (
        LanguageSubtag::new(['a', 'a', 'm']),
        LanguageSubtag::new(['a', 'a', 's']),
    ),
...
pub const EXTLANGS: [(LanguageSubtag, &str); 235] = [
...
pub const EXTLANGS_PREFERRED_VALUE: [(LanguageSubtag, LanguageSubtag); 235] = [
    (
        LanguageSubtag::new(['a', 'a', 'o']),
        LanguageSubtag::new(['a', 'a', 'o']),
    ),
...
pub const SCRIPTS: [ScriptSubtag; 197] = [
...
pub const VARIANTS: [(&str, &str); 100] = [
    ("1606nict", "frm-"),
    ("1694acad", "fr-"),
    ("1901", "de-"),
    ("1959acad", "be-"),
